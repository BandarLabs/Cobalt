...
Existing protocol-11 apps remain valid from Cobalt 0.3.1 during the 0.3.4
compatibility window. New apps that use Folio protocol-12 fields require
Cobalt 0.3.4 or newer; set that `minimum_cobalt_version` and increment the
...
`beta`, declare at least `0.3.4`, and physically confirm the beta OTA still
