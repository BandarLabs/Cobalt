...
mod tests {
    ...
    use super::{
        identify_profile, supported_profile, write_ready_profile, Bitfield, DeviceProfile,
        DeviceSnapshot, FactStatus, FramebufferPacking, FramebufferSnapshot, IdentitySnapshot,
        PageButtons, PanelColor, Readiness, TouchSnapshot, WifiHandoff, CLARA_BW_391, CLARA_BW_395,
        CLARA_COLOUR_393, CLARA_HD_376, ELIPSA_2E_389, LIBRA_2_388, LIBRA_COLOUR_390,
