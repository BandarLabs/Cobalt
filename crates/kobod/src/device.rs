...
fn host_applications(
    ...
    let result = (|| -> Result<String, String> {
        ...
        let mut pressed: Option<(kobo_ui::Rect, kobo_ui::DisplayMetrics, PressClass)> = None;
                            ...
                            TouchEvent::Down { x, y } => {
                                ...
                                if let (Ok(x), Ok(y)) = (i32::try_from(x), i32::try_from(y)) {
                                        ...
                                        .press_region(x, y)
                                    {
                                        ...
                                        surface.invert_press(press.rect, &metrics);
                                        ...
                                        pressed = Some((press.rect, metrics, press.class));
                                    }
                                }
                            }
                            TouchEvent::Up { .. } => {
...
fn release_grace(class: PressClass) -> Duration {
    match class {
        PressClass::Control => CONTROL_RELEASE_GRACE,
        PressClass::KeyboardKey => KEYBOARD_RELEASE_GRACE,
    }
}
...
impl Painter {
    ...
    fn apply(
        ...
        whole_screen: Rect,
        surface: &Surface,
        transition: &kobo_ui::FrameTransition,
    ) -> Result<(), String> {
...
mod hosting_tests {
    ...
    fn keyboard_release_gets_one_short_app_response_window() {
        assert_eq!(
            super::release_grace(kobo_ui::PressClass::Control),
            super::CONTROL_RELEASE_GRACE
        );
        assert_eq!(
            super::release_grace(kobo_ui::PressClass::KeyboardKey),
