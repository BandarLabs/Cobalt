...
const MANAGED_BUILTINS: &[BuiltinApp] = &[
    ...
    BuiltinApp {
        ...
        title: "Holy Bible",
        label: "Bible",
        summary: "Read the Holy Scriptures with offline caching and clean typography.",
        version: "1.0.0",
        glyph: Glyph::Book,
        capabilities: &["network", "hold-wifi"],
    },
    BuiltinApp {
        id: "color",
        title: "Color Patterns",
        label: "Color Test",
        summary: "Evaluate and enjoy color test patterns on Kaleido Color E Ink displays.",
        version: "1.0.0",
        glyph: Glyph::Chart,
        capabilities: &[],
    },
