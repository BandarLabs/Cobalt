...
the root user's .ssh/authorized_keys, which is the file the reader's SSH server reads to
...
the root user's .ssh/authorized_keys and is the file the reader's SSH server reads to
