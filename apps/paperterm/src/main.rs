...
impl Paperterm {
        ...
        match self.view {
            ...
            View::Watching | View::Ended => {
                ...
                if self.view == View::Ended {
                    ...
                    screen = screen.secondary("The shell remains on your computer.");
    ...
    fn grid(context: &Context) -> (u16, u16) {
        kobo_sdk::terminal_grid_for(
            ...
            &context.metrics().for_orientation(Orientation::Landscape),
        )
    }
...
mod tests {
    ...
    #[test]
    fn paperterm_uses_the_landscape_terminal_viewport() {
        let portrait =
            kobo_sdk::terminal_grid_for(&Paperterm::screen_for_grid(), &CLARA_BW_METRICS);
        let landscape = kobo_sdk::terminal_grid_for(
            &Paperterm::screen_for_grid(),
            &CLARA_BW_METRICS.for_orientation(Orientation::Landscape),
        );
        assert!(landscape.0 > portrait.0);
        assert!(landscape.1 < portrait.1);
    }
}
