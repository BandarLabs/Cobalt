...
pub const SEEK_BODY: &str = "rated=true&time=10&increment=0&variant=standard&color=random";
...
mod tests {
    use super::{
        ...
        parse_playing, rate_limit, seek, BoardRecord, Event, RateLimit, SEEK_BODY,
    };
    use kobo_sdk::Task;
