...
const screenshots = {
  ...
  deck: ["deck.png", "Deck pairing screen on a Kobo Clara BW, explaining the existing Sidekick connection."],
  ...
  frame: ["frame.png", "Monochrome sample photograph displayed by Frame on a Kobo Clara BW."],
  ...
  panels: ["panels.png", "Panels empty library with controls to open a sideloaded CBZ or browse Komga."],
